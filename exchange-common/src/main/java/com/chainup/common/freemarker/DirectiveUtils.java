package com.chainup.common.freemarker;
...
import com.chainup.common.web.springmvc.DateTypeEditor;
...
public abstract class DirectiveUtils {
	...
	public static List getList(String name, Map<String, TemplateModel> params) throws Exception{
		TemplateModel model = params.get(name);
		if (model == null) {
			return null;
		}
