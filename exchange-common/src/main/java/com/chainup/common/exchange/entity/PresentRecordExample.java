...
public class PresentRecordExample extends AbstractExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        private PresentRecordExample example;

        protected Criteria(PresentRecordExample example) {
            super();
            this.example = example;
        }

        public PresentRecordExample example() {
            return this.example;
        }
    }
