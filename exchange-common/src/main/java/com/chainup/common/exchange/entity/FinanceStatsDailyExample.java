...
public class FinanceStatsDailyExample extends AbstractExample {
    ...
    public FinanceStatsDailyExample() {
    ...
    public static class Criteria extends GeneratedCriteria {
        private FinanceStatsDailyExample example;

        protected Criteria(FinanceStatsDailyExample example) {
            super();
            this.example = example;
        }

        public FinanceStatsDailyExample example() {
            return this.example;
        }
    }
