...
public class FinanceHistoryHotExample extends AbstractExample {
    ...
    public FinanceHistoryHotExample() {
    ...
    public static class Criteria extends GeneratedCriteria {
        private FinanceHistoryHotExample example;

        protected Criteria(FinanceHistoryHotExample example) {
            super();
            this.example = example;
        }

        public FinanceHistoryHotExample example() {
            return this.example;
        }
    }
