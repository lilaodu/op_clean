...
public class TransactionDepositCryptoExample extends AbstractExample {
    ...
    public TransactionDepositCryptoExample() {
    ...
    public static class Criteria extends GeneratedCriteria {
        private TransactionDepositCryptoExample example;

        protected Criteria(TransactionDepositCryptoExample example) {
            super();
            this.example = example;
        }

        public TransactionDepositCryptoExample example() {
            return this.example;
        }
    }
