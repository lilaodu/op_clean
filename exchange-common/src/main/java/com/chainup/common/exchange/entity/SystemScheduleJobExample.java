...
* @author Solar
*/
public class SystemScheduleJobExample extends AbstractExample {
    /**
     * system_schedule_job
     */
    ...
    public SystemScheduleJobExample() {
    ...
    public static class Criteria extends GeneratedCriteria {
        private SystemScheduleJobExample example;

        protected Criteria(SystemScheduleJobExample example) {
            super();
            this.example = example;
        }

        public SystemScheduleJobExample example() {
            return this.example;
        }
    }
