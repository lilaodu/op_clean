...
public class UserBankCardExample extends AbstractExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        private UserBankCardExample example;

        protected Criteria(UserBankCardExample example) {
            super();
            this.example = example;
        }

        public UserBankCardExample example() {
            return this.example;
        }
    }
