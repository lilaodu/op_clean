...
public class ExScaleKlineExample extends AbstractExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        private ExScaleKlineExample example;

        protected Criteria(ExScaleKlineExample example) {
            super();
            this.example = example;
        }

        public ExScaleKlineExample example() {
            return this.example;
        }
    }
