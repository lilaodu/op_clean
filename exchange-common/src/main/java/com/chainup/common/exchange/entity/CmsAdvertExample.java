...
public class CmsAdvertExample extends AbstractExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        private CmsAdvertExample example;

        protected Criteria(CmsAdvertExample example) {
            super();
            this.example = example;
        }

        public CmsAdvertExample example() {
            return this.example;
        }
    }
