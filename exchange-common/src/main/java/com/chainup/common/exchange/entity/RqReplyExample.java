...
public class RqReplyExample extends AbstractExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        private RqReplyExample example;

        protected Criteria(RqReplyExample example) {
            super();
            this.example = example;
        }

        public RqReplyExample example() {
            return this.example;
        }
    }
