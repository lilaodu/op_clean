...
public class NoticeInfoExample extends AbstractExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        private NoticeInfoExample example;

        protected Criteria(NoticeInfoExample example) {
            super();
            this.example = example;
        }

        public NoticeInfoExample example() {
            return this.example;
        }
    }
