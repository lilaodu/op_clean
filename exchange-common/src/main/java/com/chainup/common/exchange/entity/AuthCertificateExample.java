...
public class AuthCertificateExample extends AbstractExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        private AuthCertificateExample example;

        protected Criteria(AuthCertificateExample example) {
            super();
            this.example = example;
        }

        public AuthCertificateExample example() {
            return this.example;
        }
    }
