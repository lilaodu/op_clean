...
public class CmsArticleTypeExample extends AbstractExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        private CmsArticleTypeExample example;

        protected Criteria(CmsArticleTypeExample example) {
            super();
            this.example = example;
        }

        public CmsArticleTypeExample example() {
            return this.example;
        }
    }
