...
public class AdminRoleUserExample extends AbstractExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        private AdminRoleUserExample example;

        protected Criteria(AdminRoleUserExample example) {
            super();
            this.example = example;
        }

        public AdminRoleUserExample example() {
            return this.example;
        }
    }
