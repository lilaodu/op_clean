...
* @author Solar
*/
public class FeeDiscountExample extends AbstractExample {
    /**
     * fee_discount
     */
    ...
    public static class Criteria extends GeneratedCriteria {
        private FeeDiscountExample example;

        protected Criteria(FeeDiscountExample example) {
            super();
            this.example = example;
        }

        public FeeDiscountExample example() {
            return this.example;
        }
    }
