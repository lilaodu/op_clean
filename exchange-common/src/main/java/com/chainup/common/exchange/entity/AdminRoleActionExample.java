...
public class AdminRoleActionExample extends AbstractExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        private AdminRoleActionExample example;

        protected Criteria(AdminRoleActionExample example) {
            super();
            this.example = example;
        }

        public AdminRoleActionExample example() {
            return this.example;
        }
    }
