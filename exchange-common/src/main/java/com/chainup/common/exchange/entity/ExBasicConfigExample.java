...
public class ExBasicConfigExample extends AbstractExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        private ExBasicConfigExample example;

        protected Criteria(ExBasicConfigExample example) {
            super();
            this.example = example;
        }

        public ExBasicConfigExample example() {
            return this.example;
        }
    }
