...
public class TransactionWithdrawCryptoExample extends AbstractExample {
    ...
    public TransactionWithdrawCryptoExample() {
    ...
    public static class Criteria extends GeneratedCriteria {
        private TransactionWithdrawCryptoExample example;

        protected Criteria(TransactionWithdrawCryptoExample example) {
            super();
            this.example = example;
        }

        public TransactionWithdrawCryptoExample example() {
            return this.example;
        }
    }
