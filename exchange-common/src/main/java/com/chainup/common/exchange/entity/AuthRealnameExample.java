...
public class AuthRealnameExample extends AbstractExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        private AuthRealnameExample example;

        protected Criteria(AuthRealnameExample example) {
            super();
            this.example = example;
        }

        public AuthRealnameExample example() {
            return this.example;
        }
    }
