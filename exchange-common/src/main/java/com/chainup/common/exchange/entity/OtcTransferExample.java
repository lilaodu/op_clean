...
public class OtcTransferExample extends AbstractExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        private OtcTransferExample example;

        protected Criteria(OtcTransferExample example) {
            super();
            this.example = example;
        }

        public OtcTransferExample example() {
            return this.example;
        }
    }
