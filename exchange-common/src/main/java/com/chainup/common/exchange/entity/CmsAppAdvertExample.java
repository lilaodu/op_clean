...
public class CmsAppAdvertExample extends AbstractExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        private CmsAppAdvertExample example;

        protected Criteria(CmsAppAdvertExample example) {
            super();
            this.example = example;
        }

        public CmsAppAdvertExample example() {
            return this.example;
        }
    }
