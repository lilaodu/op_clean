 ...
 *
 */
public class OperatePropertyUtil {
    private static final Logger logger = LoggerFactory.getLogger(OperatePropertyUtil.class);
    ...
    synchronized static private void loadProperties() {
        ...
        try {
            ...
            in = OperatePropertyUtil.class.getClassLoader().getResourceAsStream(CONFIG_PROPERTY);
    ...
    public static void main(String[] args) {
        String car_card_type = OperatePropertyUtil.getProperties("db_exchange_jdbc_url");
